...
from openerp import models, fields, api,exceptions, _, netsvc
import logging
...
class account_voucher(models.Model):
    ...
    def _amount_checks(self,voucher_id):
        ...
        if voucher_id:
            voucher_obj = self.env['account.voucher'].browse(voucher_id)
    ...
    def onchange_journal(self,journal_id, line_ids, tax_id, partner_id, date, amount,
        ...
        in the view.
        '''
        ret = super(account_voucher, self).onchange_journal(journal_id, line_ids, tax_id, partner_id,
