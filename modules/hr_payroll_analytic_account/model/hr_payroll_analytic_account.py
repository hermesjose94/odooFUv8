...
class hr_salary_rule_account(osv.osv):
    ...
    _columns = {
        'account_debit_indirect': fields.many2one('account.account', 'Cuenta deudora indirecta', required=True),
...
class hr_contract_account(osv.osv):
...
#                         })
#
#             hr_salar_rule_obj = self.pool.get('hr.salary.rule')
