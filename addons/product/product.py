...
class product_template(osv.osv):
    ...
    _columns = {
        ...
        'default_code': fields.related('product_variant_ids', 'default_code', type='char', string='Prduct Code', required=True ),
    }
...
class product_product(osv.osv):
    ...
    _sql_constraints = [
        ('default_code_unique', 'unique(default_code)', _("El Codigo de Producto introducido ya existe!")),
    ]
