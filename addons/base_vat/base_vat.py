...
class res_partner(osv.osv):
    ...
    def _construct_constraint_msg(self, cr, uid, ids, context=None):
        ...
        vat_no = "'VEV', 'VEE', 'VEG', 'VEJ'  (XXXXXXXXX)"
        ...
        return '\n' + _('El Rif [%s] para la empresa [%s] no parece ser valido. \nNote: El formato esperado es %s') % (error_partner[0].vat, error_partner[0].name, vat_no)
