...
class sale_order(osv.osv):
    ...
    _columns = {
        ...
        'vat_partner': fields.char('RIF Cliente', required=True, readonly=True),
        'code_partner': fields.char('Codigo Cliente', required=True, readonly=True),
    }
    ...
    def onchange_partner_id(self, cr, uid, ids, part, context=None):
        if not part:
            return {'value': {'partner_invoice_id': False, 'partner_shipping_id': False,  'payment_term': False, 'fiscal_position': False, 'vat_partner':False, 'code_partner':False,}}
        ...
        val = {
            ...
            'vat_partner':part['vat'],
            'code_partner':part['code'],
        }
