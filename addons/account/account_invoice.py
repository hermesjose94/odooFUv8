...
class account_invoice(models.Model):
    ...
    tipo_venta= fields.Char(string="Tipo de Venta")
    codigo = fields.Char(string="Codigo Cliente", related='partner_id.code', readonly=True)
    rif =fields.Char(string="Rif", related='partner_id.vat', readonly=True)
    type_proveedor = fields.Selection(string="Tipo de Proveedor", related='partner_id.type_provedor')
